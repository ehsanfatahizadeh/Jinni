...
public class SpecialFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        recycler_newest = (RecyclerView) view.findViewById(R.id.recycler_specials);
        adapter_newest = new NewestAdapter(getActivity() , 2 );
        ...
        new thread_get_specials(mobile).execute();
    ...
    public class thread_get_specials extends AsyncTask {


        String mobile;
        public thread_get_specials(String mobile){
            this.mobile = mobile;
        }
        ...
        protected Object doInBackground(Object[] objects) {
            Call<List<Products>> call = apis.getSpecials(mobile);
